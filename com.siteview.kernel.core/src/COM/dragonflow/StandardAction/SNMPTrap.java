...
public class SNMPTrap extends COM.dragonflow.SiteView.Action
{
    ...
    public boolean execute()
    {
        ...
        if(hasValue("_id"))
        {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if(s.equals("default"))
                {
                    ArrayList array1 = getCurrentPropertyNames();
     ...
     * @return
     */
    private static String SendSNMPTrap(String s, String s1, String s2, String s3, String s4, String s5, String s6, ArrayList array, 
