...
label1:
            {
                ...
                ArrayList array = COM.dragonflow.Page.reportPage.getReportFrames(request.getAccount());
            ...
            if(obj == null)
            {
                if(!operation.equals("adhoc"))
                {
                    ArrayList array1 = COM.dragonflow.Page.reportPage.getReportFrames(request.getAccount());
...
//        }
    ...
    static boolean isReportAllowed(HashMap hashmap, ArrayList array)
    {
label0:
        {
            if(array.size() == 0)
...
label1:
    ...
    {
        ArrayList array = COM.dragonflow.Page.reportPage.getReportFrames(httprequest.getAccount());
    ...
    public static void createReportsIndexFiles(COM.dragonflow.HTTP.HTTPRequest httprequest)
    {
        ...
        ArrayList array = COM.dragonflow.Page.CGI.getGroupFilterForAccount(httprequest);
        do
        {
            if(!enumeration.hasMoreElements())
            {
    ...
    public static ArrayList getReportFrames(String s)
    {
        ArrayList array = null;
        try
        {
            ...
            {
                ArrayList array1 = COM.dragonflow.Page.reportPage.ReadGroupFrames(s, null);
                array = new ArrayList();
    ...
    public ArrayList getReportFrameList()
    {
        ArrayList array = null;
        try
        {
    ...
    public void saveReportFrameList(ArrayList array, String s)
    {
        try
        {
            if(!COM.dragonflow.SiteView.Platform.isStandardAccount(s))
