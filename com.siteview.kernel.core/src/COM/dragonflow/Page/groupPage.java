...
public class groupPage extends COM.dragonflow.Page.CGI {
        ...
        if (request.isPost()) {
            ...
            if (s3.length() == 0
                ...
                if (s5 != null && s5.length() != 0) {
                    ...
                    try {
                        ArrayList array2 = ReadGroupFrames(s5);
    ...
    String getMonitorOptions(String s, ArrayList array, String s1)
            throws Exception {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (!s5.equals(s)) {
                ArrayList array1 = ReadGroupFrames(s5);
    ...
    String getMonitorTemplateOptionsHTML(String s) {
        ArrayList array = COM.dragonflow.Properties.PropertiedObject
        ...
        if (request.isPost()) {
            ...
            try {
                ...
                if (s3.length() == 0
                    ...
                    if (s7.length() != 0) {
                        ArrayList array1 = ReadGroupFrames(s7);
