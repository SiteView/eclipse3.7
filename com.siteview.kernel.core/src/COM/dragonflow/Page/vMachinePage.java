...
public class vMachinePage extends COM.dragonflow.Page.prefsPage {
    ...
    public static boolean createGroupFromRequest(String s, String s1,
        ...
        if (s3 != null && s3.length() != 0) {
            ...
            try {
                ArrayList array1 = cgi.ReadGroupFrames(s3);
    ...
    public static ArrayList readDynamicSets() {
        ArrayList array = new ArrayList();
    ...
    void printListForm(String s) throws Exception {
        ...
        ArrayList array = getListTableHeaders();
        outputStream
                .println("<p><H2>"
                        + s2
        ...
        ArrayList array1 = COM.dragonflow.Page.vMachinePage.readDynamicSets();
        if (array1.size() == 0) {
            outputStream
            ...
            for (Enumeration enumeration = (Enumeration) array1.iterator(); enumeration
                ...
                ArrayList array2 = getListTableRow(hashmap);
                outputStream.println("<TR>");
    ...
    public void saveDynamicFrameList(ArrayList array, String s) {
        try {
    ...
    ArrayList getListTableRow(HashMap hashmap) {
        ArrayList array = new ArrayList();
