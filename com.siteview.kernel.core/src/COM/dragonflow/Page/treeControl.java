...
public class treeControl extends COM.dragonflow.Page.CGI {
    ...
    public treeControl(COM.dragonflow.HTTP.HTTPRequest httprequest,
            String s, boolean flag, ArrayList array, boolean flag1) {
    ...
    public boolean process(String s, String s1,
            String s2, ArrayList array, ArrayList array1,
            ArrayList array2, int i, COM.dragonflow.Page.CGI cgi1,
    ...
    private void selectNodes(String s, String s1,
        ...
        if (s.equals("_master")) {
            COM.dragonflow.Properties.HashMapOrdered hashmapordered = new HashMapOrdered(
                    true);
            ArrayList array = cgi.getGroupNameList(hashmapordered, null, null,
                    true);
    ...
    public void saveTreeState() {
        ...
        ArrayList array = getFrames(stringbuffer);
        boolean flag = false;
        boolean flag1 = false;
    ...
    private ArrayList getFrames(StringBuffer stringbuffer) {
    ...
    private void getTreeState() {
        ...
        state.clear();
        selected.clear();
        ArrayList array = getFrames(new StringBuffer());
