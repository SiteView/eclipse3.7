        ...
        throws java.lang.Exception
    {
        ...
        for(int l = 0; l < j; l++)
        {
            ...
            do
            {
                ...
                ArrayList array = TextUtils.getMultipleValues(hashmap3, s12);
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if(flag)
            {
                ...
                do
                {
                    ...
                    {
                        ArrayList array = TextUtils.getMultipleValues(hashmap2, s8);
                        StringBuffer stringbuffer = new StringBuffer();
        ...
        throws java.lang.Exception
    {
        ...
        if(s1.indexOf("SubGroup") == -1)
        {
            ...
            for(Enumeration enumeration = array2.elements(); enumeration.hasMoreElements();)
            {
                ...
                {
                    ArrayList array3 = TextUtils.getMultipleValues(hashmap, stringproperty.getName());
                ...
                } else
                {
                    ...
                    {
                        ArrayList array4 = TextUtils.getMultipleValues(hashmap, stringproperty.getName());
                        atomicmonitor.unsetProperty(stringproperty);
                        int j1 = 0;
        ...
        throws java.lang.Exception
    {
        ...
        if(s1.indexOf("SubGroup") == -1)
        {
            ...
            do
            {
                ...
                if(stringproperty.isMultiLine)
                {
                    ArrayList array1 = TextUtils.getMultipleValues(hashmap, stringproperty.getName());
                    int j = 0;
                    while(j < array1.size()) 
                    {
                ...
                } else
                {
                    ...
                    if((stringproperty instanceof ScalarProperty) && ((ScalarProperty)stringproperty).multiple)
                    {
                        ArrayList array2 = TextUtils.getMultipleValues(hashmap, stringproperty.getName());
