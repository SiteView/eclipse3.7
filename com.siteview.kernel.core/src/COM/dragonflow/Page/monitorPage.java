...
public class monitorPage extends COM.dragonflow.Page.CGI
{
    ...
    static ArrayList monitorNames = null;
    ...
    public static ArrayList getMonitorClasses(boolean flag)
    {
        return COM.dragonflow.Page.monitorPage.getMonitorClasses(null, flag);
    }

    public static ArrayList getMonitorClasses()
    {
        return COM.dragonflow.Page.monitorPage.getMonitorClasses(null, false);
    }

    public static ArrayList getMonitorClasses(COM.dragonflow.Page.CGI cgi, boolean flag)
    {
    ...
    private String getNTAssociatedCountersContent(AtomicMonitor atomicmonitor, String s, String s1)
    {
        ...
        ArrayList array1 = NTCounterBase.getPerfCounters(s1, array, stringbuffer, "");
...
label0:
    ...
    void printForm(String s, String s1, AtomicMonitor atomicmonitor, HashMap hashmap, ArrayList array)
        throws java.io.IOException
    {
        ...
        if(atomicmonitor.getClassPropertyString("applicationType").equals("NTCounter"))
        {
            ...
            } else
            {
                ...
                if(s2.length() == 0)
                {
                    ArrayList array1 = ((NTCounterBase)atomicmonitor).getAvailableCounters();
                    if(array1.size() > 0)
                    {
    ...
    void printOrdering(Monitor monitor, ArrayList array)
    {
    ...
    int calculateVariablePropertyCount(ArrayList array, Monitor monitor)
    {
        int i = -1;
        int j = -1;
        int k = -1;
...
//                        }
                    ...
                    if(atomicmonitor instanceof BrowsableMonitor)
                    {
                        ...
                        ArrayList array2 = ((BrowsableMonitor)atomicmonitor).getConnectionProperties();
                    ...
                    ArrayList array1 = atomicmonitor.getProperties();
...
//                                                }
                    ...
                    ArrayList array3 = ReadGroupFrames(s2);
                    String s16 = "";
                    if(s.equals("Add"))
                    {
...
//                    }
     ...
     * @param s1
     */
    void printMonitorTools(ArrayList array, String s, String s1)
    {
     ...
     * @param s2
     */
    void printClasses(String s, ArrayList array, String s1, String s2)
    {
        Enumeration enumeration;
        boolean flag;
        boolean flag1;
    ...
    synchronized void printClasseList(String s, ArrayList array)
    {
        int i = 0;
        int j = 0;
        ...
        throws java.lang.Exception
    {
        ...
        if(request.isPost() && COM.dragonflow.Page.treeControl.notHandled(request))
        {
            ...
            {
                SiteViewGroup siteviewgroup = SiteViewGroup.currentSiteView();
                ArrayList array2 = ReadGroupFrames(s2);
...
//                }
        ...
        {
            ArrayList array1 = ReadGroupFrames(s2);
        ...
        throws java.io.IOException
    {
        ...
        if(args.length > 0)
        {
            ...
            ArrayList array = COM.dragonflow.Page.monitorPage.getMonitorClasses(monitorpage, false);
            if(args[0].equals("-logproperties"))
            {
                ...
                for(int i = 0; i < array.size(); i++)
                {
                    ...
                    try
                    {
                        ...
                        ArrayList array1 = monitor.getLogProperties();
            ...
            if(args[0].equals("-dblogproperties"))
            {
                ...
                for(int j = 0; j < array.size(); j++)
                {
                    ...
                    try
                    {
                        ...
                        ArrayList array2 = monitor1.getLogProperties();
