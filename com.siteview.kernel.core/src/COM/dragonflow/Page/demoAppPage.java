...
public class demoAppPage extends COM.dragonflow.Page.CGI
{
    ...
    {
        ArrayList array = COM.dragonflow.Properties.FrameFile.readFromFile(COM.dragonflow.SiteView.Platform.getRoot() + "/groups/demoCatalog.config");
    ...
    HashMap findFrame(ArrayList array, String s, String s1)
    {
        for(int i = 0; i < array.size(); i++)
        {
            HashMap hashmap = (HashMap)array.get(i);
