...
public class mapbuilderPage extends COM.dragonflow.Page.CGI
{
    ...
    public HashMap MonitorDisplayHash(HashMap hashmap)
    {
        try
        {
            ArrayList array = COM.dragonflow.Properties.FrameFile.readFromFile(COM.dragonflow.SiteView.Platform.getRoot() + "/templates.view/xsltemplates.conf");
    ...
    public HashMap loadConfig(HashMap hashmap, String s)
    {
        try
        {
            ArrayList array = COM.dragonflow.Properties.FrameFile.readFromFile(COM.dragonflow.SiteView.Platform.getRoot() + "/templates.view/" + s + "");
            if(array != null && array.size() > 0)
            {
                hashmap = (HashMap)array.get(0);
            }
