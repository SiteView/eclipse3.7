...
public class LineReader {
    ...
    public LineReader(ArrayList array) {
        lineNumber = 0;
        startLine = 0;
        endLine = 0x7fffffff;
        headerLine = 1;
    ...
    public LineReader(ArrayList array, COM.dragonflow.SiteView.OSAdapter osadapter, String s) {
        this(array);
        ...
        ArrayList array2 = osadapter.getMatchedCommandSettings(s, "ColumnName");
        if (array2.size() > 0) {
