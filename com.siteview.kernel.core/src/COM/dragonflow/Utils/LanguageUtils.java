...
public class LanguageUtils {
    ...
    static HashMap getLanguage(String s) {
        ...
        if (hashmap == null) {
            try {
                ArrayList array = COM.dragonflow.Properties.FrameFile.readFromFile(COM.dragonflow.SiteView.Platform.getRoot() + java.io.File.separator + "templates.language" + java.io.File.separator + s + ".txt");
