...
public class MgParser
{
        ...
        throws java.io.IOException
    {
        ...
        ArrayList array = COM.dragonflow.Utils.MgParser.split('\n', s1);
        return COM.dragonflow.Utils.MgParser.readFrames((Enumeration) array.iterator());
    }

    private static ArrayList readFrames(Enumeration enumeration)
        throws java.io.IOException
    {
    ...
    private static ArrayList split(char c, String s)
    {
        ArrayList array = new ArrayList();
        int i = 0;
