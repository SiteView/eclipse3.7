...
public class XSLUtils
{
    ...
    public static int matchXML(String s, String s1, ArrayList array, StringBuffer stringbuffer)
    {
    ...
    public static void findElements(org.w3c.dom.Node node, String s, ArrayList array)
    {
        String s1 = s;
        String s2 = "";
        int i = s.indexOf('.');
