...
public class URLContext {
    ...
    public void setPostData(ArrayList array) {
        postData = array;
    }
    ...
    public void setCookies(ArrayList array) {
        cookies = array;
    }
    ...
    private ArrayList addCookie(ArrayList array, HashMap hashmap) {
        boolean flag = false;
    ...
    public static void printCookie(ArrayList array) {
    ...
    private void updateOrAddOneCookie(ArrayList array, String s, String s1) {
