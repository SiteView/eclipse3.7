...
public class MailUtils {
    ...
    public static String mail(HashMap hashmap, String s, String s1, String s2, String s3, ArrayList array) {
        return COM.dragonflow.Utils.MailUtils.mail(hashmap, s, s1, s2, s3, array, true);
    }

    public static String mail(HashMap hashmap, String s, String s1, String s2, String s3, ArrayList array, boolean flag) {
        return COM.dragonflow.Utils.MailUtils.mail(hashmap, s, s1, s2, s3, array, flag, "");
    }

    public static String mail(HashMap hashmap, String s, String s1, String s2, String s3, ArrayList array, boolean flag, String s4) {
        return COM.dragonflow.Utils.MailUtils.mail(hashmap, s, s1, s2, s3, array, flag, s4, null);
    }

    public static String mail(HashMap hashmap, String s, String s1, String s2, String s3, ArrayList array, boolean flag, String s4, String s5) {
        ...
        if (s8.length() != 0) {
            String s7 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "_mailServerBackup");
            if (s7.length() > 0) {
    ...
    static String mail1(HashMap hashmap, String s, String s1, String s2, String s3, String s4, ArrayList array, boolean flag, String s5, String s6) {
        ...
        String s13 = "";
        try {
            String s15 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "_mailSubjectMax");
            ...
            String s19 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "_mailTimeout");
            if (s19.length() > 0) {
