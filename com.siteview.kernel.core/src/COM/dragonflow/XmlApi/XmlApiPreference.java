...
public class XmlApiPreference {
    ...
    public java.lang.Object update(ArrayList array, ArrayList array1, ArrayList array2, ArrayList array3, ArrayList array4) throws COM.dragonflow.SiteViewException.SiteViewException {
        COM.dragonflow.XmlApi.XmlApiResponse xmlapiresponse = new XmlApiResponse();
        try {
            java.util.Vector vector = new Vector();
            int i = 0;
