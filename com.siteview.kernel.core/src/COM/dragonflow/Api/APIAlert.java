...
public class APIAlert extends COM.dragonflow.Api.APISiteView
{
    ...
    private COM.dragonflow.SiteView.Action getAction(COM.dragonflow.Api.Alert alert)
    {
        ...
        ArrayList array = COM.dragonflow.SiteView.Platform.split('\t', alert.getCondStr());
        if(array.size() > 1)
        {
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            s1 = "COM.dragonflow.StandardAction." + s;
            ArrayList array = getPropertiesForClass(siteviewobject, s1, "Action", i);
            ArrayList array1 = getSynthesizedAlertProperties(null, null, null, i);
            ...
            if(array.size() > 0)
            {
                ...
                while (enumeration.hasMoreElements())
                    ...
                    if(s3.length() == 0 && s4.equals("_master") || s4.equals(s3))
                    {
                        ...
                        {
                            ArrayList array1 = findCondition(COM.dragonflow.Utils.I18N.toDefaultEncoding(s4), s6, s5);
                            if(array1.size() > 1)
                            {
                                ...
                                ArrayList array4 = getSynthesizedAlertProperties(null, null, null, COM.dragonflow.Api.APISiteView.FILTER_ALL);
                                int j = 0;
                                while(j < array4.size()) 
                                {
            ...
            if(array.size() > 0)
            {
                ...
                while (enumeration.hasMoreElements())
                    ...
                    if(s3.equals("_master") || s3.equals(s2))
                    {
                        ...
                        {
                            ArrayList array1 = findCondition(COM.dragonflow.Utils.I18N.toDefaultEncoding(s3), s5, s4);
                            if(array1.size() > 2)
                            {
    ...
    private ArrayList findCondition(String s, String s1, String s2)
        throws java.lang.Exception
    {
    ...
    private HashMap findMonitor(ArrayList array, String s)
        throws java.lang.Exception
    {
    ...
    private String conditionName(String s, HashMap hashmap, ArrayList array)
    {
        String s2 = null;
        if(array.size() > 3)
        {
    ...
    void getActionArguments(String s, ArrayList array, HashMap hashmap)
    {
        int i = s.indexOf(" ");
        String as[];
        if(i >= 0)
        ...
        throws java.lang.Exception
    {
        ...
        ArrayList array1 = action.getProperties();
        ...
        ArrayList array2 = getSynthesizedAlertProperties(action, s, hashmap, i);
    ...
    private ArrayList getSynthesizedAlertProperties(COM.dragonflow.SiteView.Action action, String s, HashMap hashmap, int i)
        throws java.lang.Exception
    {
        ArrayList array = new ArrayList();
    ...
    private String displayName(String s, ArrayList array)
        throws java.lang.Exception
    {
        String s1 = null;
        if(array.size() > 3)
        ...
        if(s.equals("_master"))
        {
            ...
            if(s1 != null && s1.length() > 0)
            {
                COM.dragonflow.SiteView.SiteViewObject siteviewobject = getSiteView();
                StringBuffer stringbuffer = new StringBuffer();
                ArrayList array1 = COM.dragonflow.SiteView.Platform.split(',', s1);
                for(int i = 0; i < array1.size(); i++)
                {
        ...
        if(!COM.dragonflow.SiteView.Platform.isStandardAccount(account) && s.equals(account))
        {
            if(s1 != null && s1.length() > 0)
            {
                ...
                ArrayList array2 = COM.dragonflow.SiteView.Platform.split(',', s1);
    ...
    private ArrayList getAllowedGroupIDs()
    {
        return getAllowedGroupIDsForAccount();
    }

    private ArrayList getAllowedGroupIDsForAccount()
    {
    ...
    private ArrayList filterGroupsForAccount(ArrayList array)
    {
        ArrayList array1 = getGroupFilterForAccount("");
    ...
    private Enumeration getMonitors(ArrayList array)
    {
        ArrayList array1 = new ArrayList();
        Enumeration enumeration = (Enumeration) array.iterator();
        if(enumeration.hasMoreElements())
    ...
    private HashMap mungeCondition(COM.dragonflow.Api.Alert alert, String s)
    {
        ...
        try
        {
            ArrayList array = ReadGroupFrames(alert.getGroup());
