...
public class APIPreference extends COM.dragonflow.Api.APISiteView
{
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            ArrayList array = getPropertiesForClass(preferences, s1, "Preferences", COM.dragonflow.Api.APISiteView.FILTER_CONFIGURATION_ADD_ALL);
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            COM.dragonflow.SiteView.Preferences preferences = (COM.dragonflow.SiteView.Preferences)class1.newInstance();
            ArrayList array = getPropertiesForClass(preferences, s3, "Preferences", COM.dragonflow.Api.APISiteView.FILTER_CONFIGURATION_EDIT_ALL);
            hashmap = preferences.validateProperties(hashmap, array, new HashMap());
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            ArrayList array = getPropertiesForClass(siteviewobject, s1, "Preferences", i);
            java.util.Vector vector = new Vector();
