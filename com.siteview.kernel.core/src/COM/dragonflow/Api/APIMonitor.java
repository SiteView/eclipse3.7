...
public class APIMonitor extends APISiteView
{
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            ConfigurationChanger configurationchanger = new ConfigurationChanger();
            String as[] = new String[0];
            ArrayList array2 = getGroupFrames(s1);
            ...
            ArrayList array3 = configurationchanger.manageMonitors(array, array1, s2, false, as);
...
//                ssstringreturnvalue = getTopazID(atomicmonitor);
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        ArrayList array = ReadGroupFrames(s1);
...
//                assinstanceproperty[k] = new SSInstanceProperty("topazMonitorID", TopazInfo.getTopazName() + " Monitor ID", ssstringreturnvalue.getValue());
    ...
    private java.util.Vector createThresholdProperties(int i, ArrayList array, SiteViewObject siteviewobject, java.util.HashMap hashmap)
    {
        java.util.Vector vector = new Vector();
    ...
    protected java.util.Vector getThresholds(ArrayList array, SiteViewObject siteviewobject, java.util.HashMap hashmap)
    {
    ...
    private void getThresholdCounters(java.util.HashMap hashmap, ArrayList array, int i)
    {
    ...
    private SSPropertyDetails getThreshold(String s, ArrayList array, Monitor monitor)
    {
        ...
        throws COM.dragonflow.SiteViewException.SiteViewException
    {
        ...
        try
        {
            ...
            {
                ArrayList array1 = ((BrowsableMonitor)atomicmonitor).getConnectionProperties();
                int j = 0;
                do
                {
                    if(j >= array1.size())
            ...
            if(stringproperty instanceof COM.dragonflow.Properties.StringProperty)
            {
                ...
                if((atomicmonitor instanceof NTCounterBase) && stringproperty.getName() != null && stringproperty.getName().equals("availableObjects"))
                {
                    ...
                    if(s6 != null)
                    {
                        ...
                        ArrayList array7 = ((NTCounterBase)atomicmonitor).getAvailableCounters();
                        HashMap hashmap2 = new HashMap();
                ...
                if((atomicmonitor instanceof NTCounterBase) && stringproperty.getName() != null && stringproperty.getName().equals("availableCounters"))
                {
                    ...
                    if(s13 != null)
                    {
                        ...
                        {
                            array8.add(s16);
                            ArrayList array3 = NTCounterBase.getPerfCounters(s13, array8, stringbuffer2, "");
                ...
                if((atomicmonitor instanceof NTCounterBase) && stringproperty.getName() != null && stringproperty.getName().equals("availableInstances"))
                {
                    ...
                    if(s14 != null)
                    {
                        ...
                        {
                            array9.add(s17);
                            ArrayList array5 = NTCounterBase.getPerfCounters(s14, array9, stringbuffer3, "");
...
//                            }
                ...
                {
                    ArrayList array6 = ((ApplicationBase)atomicmonitor).getAvailableCounters();
                    if(array6 != null)
                    {
...
//                        }
    ...
    private ArrayList getNodeNames(org.w3c.dom.Node node)
    {
        ArrayList array = new ArrayList();
        String s = ((org.w3c.dom.Element)node).getAttribute("name");
        if(s == null)
