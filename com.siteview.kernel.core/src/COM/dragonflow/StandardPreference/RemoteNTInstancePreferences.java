...
public class RemoteNTInstancePreferences extends COM.dragonflow.SiteView.Preferences {
    ...
    public java.util.Vector getScalarValues(COM.dragonflow.Properties.ScalarProperty scalarproperty, COM.dragonflow.HTTP.HTTPRequest httprequest, COM.dragonflow.Page.CGI cgi) throws COM.dragonflow.SiteViewException.SiteViewException {
        ...
        if (scalarproperty == pOs) {
            ArrayList array = COM.dragonflow.SiteView.Machine.getAllowedOSs();
            ...
            ArrayList array1 = COM.dragonflow.SiteView.Machine.getNTAllowedMethods();
            ...
            ArrayList array2 = COM.dragonflow.SiteView.Machine.getAllowedSshAuthMethods();
            ...
            ArrayList array3 = COM.dragonflow.SiteView.Machine.getAllowedSshConnectionMethods();
    ...
    private void saveMachines(ArrayList array, String s) {
    ...
    private HashMap findMachine(ArrayList array, String s) {
    ...
    private ArrayList readMachines(String s) {
        ArrayList array = new ArrayList();
        HashMap hashmap = COM.dragonflow.SiteView.MasterConfig.getMasterConfig();
        String s1;
